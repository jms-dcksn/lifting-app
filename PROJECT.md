...
| Status | Meaning |
|--------|---------|
| **Now** | 90-day wedge only: progression science + coach loop + what the first user (friend) needs |
| **Feedback** | User feedback from the friend / future users |
| **Dogfood** | James's own improvement notes from using the app |
| **Later** | Parked: native iOS migration, in-app AI coach, and other out-of-scope items |

## 90-day scope freeze rules

1. **Wedge only.** Active delivery stays in **Now**: progression science, coach loop, and friend-first UX. Do not pull **Later** work into the current slice without an explicit scope change.
...
4. **Later is a parking lot.** Native iOS, in-app AI coach, and similar bets stay in **Later** until the 90-day wedge is proven.
