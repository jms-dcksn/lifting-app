...
**Status:** Slices A–E shipped. Slice B unifies `/history/[exerciseId]` (month is back-link
...
month-to-month compare and program captions. Slice F remains proposed (entry equipment
params).
