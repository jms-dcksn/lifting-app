...
export const config = {
  matcher: [
    ...
    // Skip throwaway /prototype/* visual studies so they can be reviewed
    // without a Supabase session refresh.
    "/((?!_next/|favicon.ico|manifest.webmanifest|prototype/|.*\\.(?:svg|png|jpg|jpeg|gif|webp|ico)$).*)",
  ],
};
